...
void Misaki_Meniu() {
        ...
        ImGui::SetNextWindowBgAlpha(g_Misaki_Menu_alpha);
        ImGui::Begin("Misaki", nullptr, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_AlwaysAutoResize);
        {
            ImGui::Text(reinterpret_cast<const char*>(u8"PASS"));
            ImGui::Text(reinterpret_cast<const char*>(u8"Tab Close Menu"));
        }
        ImGui::End();
}
